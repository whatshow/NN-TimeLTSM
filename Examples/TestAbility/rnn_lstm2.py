...
class RNN_LSTM2:
    ...
    def __call__(self, path, device, lstm_layer_neuron_num, lstm_in_feature_num, time_step, epoch_iter, learning_rate, data_train_x, data_train_y, data_test_x):
        ...
        # build the model
        model = nn.LSTM(1, lstm_layer_neuron_num, 2, batch_first=True);
        ...
        has_trained = False;
        if os.path.exists(self.modelfile_lstm_ag) and os.path.exists(self.modelfile_dnn1) and os.path.exists(self.modelfile_dnn2):
            has_trained = True;
