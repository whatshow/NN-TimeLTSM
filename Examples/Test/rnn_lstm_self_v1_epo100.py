...
sys.path.append("../..");
from LSTM_v1 import TimeLSTM_v1 as TimeLSTM

# 1 feature
class RNN_LSTM_self_v1_epo100:
    
    folder      = "rnn_lstm_v1_self_epo100/"
    modelfile   = "rnn_lstm_self_v1.pkl";
    ...
    def __call__(self, path, device, lstm_layer_neuron_num, lstm_in_feature_num, time_step, epoch_iter, epoch_size, batch_size, learning_rate, data_train_x, data_train_y, data_test_x):
        ...
        print("- RNN_LSTM_self_v1 (100 epo)");
        # try to train
        if not has_trained:
            print("  - train");
            model.train();
